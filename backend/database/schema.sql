...
VALUES (
        ...
        'Prof. Dr.',
        'Bilgisayar Mühendisliği',
        'akademisyen_hakem@izu.edu.tr',
        '5555555552',
        true,
        '$2a$10$kHe1CybkltpFDSnd7PvEleMkyNcisc0C9s.Poz8v94lt0POdHfUt6',
        true
    ) ON CONFLICT (eposta) DO NOTHING;
-- Akademisyen Hakem kullanıcısına sistem rollerini ata
INSERT INTO sistem_rol (uye_id, sistem_rol_id)
SELECT u.uye_id,
    srt.rol_id
FROM uye u,
    sistem_rol_tanimlama srt
WHERE u.eposta = 'akademisyen_hakem@izu.edu.tr'
    AND srt.rol_adi IN ('akademisyen', 'hakem') ON CONFLICT (uye_id, sistem_rol_id) DO NOTHING;
